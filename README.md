...
**N.B. This fork contains a quick fix to prevent $$watchers being added to elements if required. Useful for flat lists with many items.**

**The new attributes that can be added to the relevant elements are:**
